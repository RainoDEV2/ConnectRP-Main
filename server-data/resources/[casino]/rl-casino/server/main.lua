...
RegisterServerEvent("rl-casino:sharlock:sell")
AddEventHandler("rl-casino:sharlock:sell", function()
    local src = source
    local price = 0
...
function SetExports()
exports["rl-blackjack"]:SetGetChipsCallback(function(source)
    ...
    return TriggerClientEvent('RLCore:Notify', src, "You have no chips..")
end)

    exports["rl-blackjack"]:SetTakeChipsCallback(function(source, amount)
        local Player = RLCore.Functions.GetPlayer(source)
    ...
    exports["rl-blackjack"]:SetGiveChipsCallback(function(source, amount)
        local Player = RLCore.Functions.GetPlayer(source)
...
AddEventHandler("onResourceStart", function(resourceName)
	if ("rl-blackjack" == resourceName) then
        Citizen.Wait(1000)
        SetExports()
    end
end)
            ...
            if xPlayer.PlayerData.money['cash'] >= amount then
                ...
                SetTimeout(12000, function()
                    ...
                    elseif _priceIndex == 3 or _priceIndex == 7 or _priceIndex == 15 or _priceIndex == 20 then
                        ...
                        xPlayer.Functions.RemoveMoney('cash', _money)
