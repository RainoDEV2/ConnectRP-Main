RegisterServerEvent('RLCore:DebugSomething')
AddEventHandler('RLCore:DebugSomething', function(resource, obj, depth)
...
RLCore.Debug = function(resource, obj, depth)
    TriggerEvent('RLCore:DebugSomething', resource, obj, depth)
end

RLCore.ShowError = function(resource, msg)
    print("\x1b[31m["..resource..":ERROR]\x1b[0m "..msg)
end

RLCore.ShowSuccess = function(resource, msg)
