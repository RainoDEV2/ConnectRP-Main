...
Config.Jobs = {
    ['taco'] = {
        ...
        ['settings'] = {
            ...
            name = 'Taco run',
            cooking = 'Press ~r~E~w~ to make tacos',
            packaging = 'Press ~r~E~w~ to package tacos',
            ready = "Press ~r~E~w~ to put bag out for delivery",
            cancle = "Press ~r~E~w~ to cancel delivery",
            food_item = 'taco',
            bag_item = 'taco-bag',
            ...
            pickup = "Press ~r~E~w~ to deliver food.",
            dropoff = "Press ~r~E~w~ to drop off package.",
            boss = "Press ~r~E~w~ to open boss menu",
            shop = "Press ~r~E~w~ to open the shop",
    ...
    --[[['coffee'] = {
        ...
        ['settings'] = {
            ...
            private_deliveries = false,
            name = 'Coffee Run',
            cooking = 'Press ~r~E~w~ to make coffe',
            packaging = 'Press ~r~E~w~ to package coffe',
            ready = "Press ~r~E~w~ to put bag out for delivery",
            cancle = "Press ~r~E~w~ to cancel delivery",
            food_item = 'coffee',
            bag_item = 'coffeebag',
            ...
            preparing = "Preparing Delivery..",
            pickup = "Press ~r~E~w~ to deliver coffee.",
            dropoff = "Press ~r~E~w~ to drop off package.",
            boss = "Press ~r~E~w~ to open boss menu",
            shop = "Press ~r~E~w~ to open the shop",
    ...
    ['burgershot'] = {
        ...
        ['settings'] = {
            ...
            private_deliveries = false,
            name = 'Burgers run',
            cooking = 'Press ~r~E~w~ to make burger',
            packaging = 'Press ~r~E~w~ to package burgers',
            ready = "Press ~r~E~w~ to put bag out for delivery",
            cancle = "Press ~r~E~w~ to cancel delivery",
            food_item = 'burger',
            bag_item = 'burger-bag',
            ...
            preparing = "Preparing Delivery..",
            pickup = "Press ~r~E~w~ to deliver burgers.",
            dropoff = "Press ~r~E~w~ to drop off package.",
            boss = "Press ~r~E~w~ to open boss menu",
            shop = "Press ~r~E~w~ to open the shop",
