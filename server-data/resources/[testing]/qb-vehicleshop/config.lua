...
RL.SpawnPoint = {x = -59.18, y = -1109.71, z = 25.45, h = 68.5}
RL.DefaultGarage = "centralgarage"

RL.QuickSell = {x = -46.54, y = -1081.66, z = 25.75, h = 228.5, r = 1.0}
...
RL.DefaultBuySpawn = {x = -56.79, y = -1109.85, z = 26.43, h = 71.5}

RLCustom.VehicleBuyLocation = {x = -772.82, y = -235.39, z = 37.07, h = 201.5, r = 1.0}
RLCustom.ShowroomPositions = {
    [1] = {
        coords = {
            x = -792.46, 
            y = -233.15, 
