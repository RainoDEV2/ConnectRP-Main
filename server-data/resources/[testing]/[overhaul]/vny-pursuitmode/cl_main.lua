Citizen.CreateThread(function()
    print(Veny.notify)
    if Veny.notify == "RLCorenotify" then
        while RLCore == nil do
            ...
            if vehicle ~= 0 then
                ...
                if vehiclehash == Veny.PursuitCar1 or vehiclehash == Veny.PursuitCar2 or vehiclehash == Veny.PursuitCar3 or vehiclehash == Veny.PursuitCar4 then
                    ...
                    if mode4 then
                        ...
                        elseif Veny.notify == "RLCorenotify" then
                            RLCore.Functions.Notify("Pursuit Mode: A+", "success")
                    ...
                    elseif mode1 then
                        ...
                        elseif Veny.notify == "RLCorenotify" then
                            RLCore.Functions.Notify("Pursuit Mode: S", "success")
                        elseif Veny.notify == "esxshownotification" then
                    ...
                    elseif Veny.notify == "RLCorenotify" then
                        RLCore.Functions.Notify("You are not in a pursuit car", "error")
                    elseif Veny.notify == "esxshownotification" then
                ...
                elseif Veny.notify == "RLCorenotify" then
                    RLCore.Functions.Notify("You are not in a car", "error")
                elseif Veny.notify == "esxshownotification" then
